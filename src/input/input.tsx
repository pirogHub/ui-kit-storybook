...
> = ({ label, placeholder, error, inputAs, _isFocusedManual }) => {
  ...
  return (
    <RowsWrapper>
      <Root className={error ? "error" : ""}>
        ...
        >
          ...
          <StyledInputWrapper className="input-field">
            ...
            />
            <label className={_isFocusedManual ? "onManualTop" : ""}>
              {label}
            </label>
        ...
        <div style={{ display: "flex", paddingBlock: "15px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <Icon2
              size={24}
              color="#A4A5B1"
              url={getIconUrlByName("helpCircle")}
            />
          </div>
          <div style={{ display: "flex", alignItems: "center" }}>
            <Icon2
      ...
      {
        <ErrorWrapper isVisible={Boolean(error)}>
          {error || "empty"}
        </ErrorWrapper>
      }
    </RowsWrapper>
...
// export const InputField: FC<MyInputProps> = ({
//   big,
//   placeholder,
//   label,
//   ...props
